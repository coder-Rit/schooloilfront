    ...
    <>
      {windowSizing.innerWidth >= 768 ? (
        <div className="userAcountMainDiv" style={props.main.main}>
          ...
          <div style={props.main.sub_body}>
            {typeof acountdetails.email !== "undefined" && isDividionGeted ? (
              <>
                <HeaderComp
                  type={`${acountdetails.tName} `}
                ></HeaderComp>
                <div className="div786 glassTheme">
                  ...
                  <div>
                    ...
                    <div>
                      <span>{acountdetails.rollNumber}</span>
                    </div>
                    <div>
                      <span>{acountdetails.department}</span>
                    </div>
                  </div>
            ...
            <div className="filterDivAtStudent">
              <button style={props.main.BTN} className="divisionBTN">
                Last Week
              </button>
              <button style={props.main.BTN} className="divisionBTN">
                Last Month
            ...
            <div className="attendaceDivAtStudent">
              <div className="presentyDataDiv boxShodow">
                <span> Lectures Presenty </span>
                ...
                <br />
                <span> Attended lecturs : {No_of_doned_Lecture}/</span>
                <br />
                <span> Skiped lecturs : {No_of_Undoned_Lecture}</span>
              </div>
              <div className="presentyDataDiv boxShodow">
                <span> practical Presenty </span>
                <div style={{ width: 200, height: 200 }}>
                  <CircularProgressbar
                ...
                <br />
                <span> Attended Practical : {No_of_doned_Practical}</span>
                <br />
                <span> Skiped Practical : {No_of_Undoned_Practical}</span>
              </div>
            </div>
          </div>
        </div>
