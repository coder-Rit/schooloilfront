...
const UpdateTimeTable = (props) => {
  ...
  return (
    <Fragment>
      {windowSizing.innerWidth >= 768?(<div className="userAcountMainDiv glassTheme" style={props.main.main}>
      ...
      <div >
        ...
        <div className="tableDiv " style={props.main.div_box}>
          <table>
            <tr>
              <th className="table_th">Time</th>
              <th className="table_th">Monday</th>
              <th className="table_th">Tuesday</th>
              <th className="table_th">Wednesday</th>
              <th className="table_th">Thursday</th>
              <th className="table_th">Friday</th>
              <th className="table_th">Saturday</th>
              <th className="table_th">Sunday</th>
            </tr>
            <tr>
              <td>
                <input
