          ...
          <div>
            <div>
              ...
              <div className="div745">
                <div className="updateDivisionDiv glassTheme">
                  <form onSubmit={add_Division}>
                    <div className="div4866">
                      <div>
                        ...
                        <div className="lable_N_Input_Pack_At_Update_Division">
                          <label htmlFor="groupOFyears">Year</label>
                          {isUserDetailUpdated
                      ...
                      <div>
                        <span>Set Batches</span>

                        <div className="div4726">
                          <div className="lable_N_Input_Pack_At_Update_Division">
                            <label>1st batch</label>
                            <input
                              type="text"
                              name="batch_name1"
                              value={batch_name1}
                        ...
                        <div className="div4726">
                          <div className="lable_N_Input_Pack_At_Update_Division">
                            <label>2ed batch</label>
                            <input
                              type="text"
                              name="batch_name2"
                              value={batch_name2}
                              Roll. toame="updateInputs inputSize"
                              onChange={formChange}
                      ...
                      {is_all_user_data_ready
                        ? userList.map((data) => {
                            return (
                              <div key={data._id} className="userDiv">
                                <input
                                  type="checkBox"
                                  value={data._id}
                                  checked={
                                ...
                                />
                                <span>{data.personalInfo.fistName}</span>
                                <span>{data.role}</span>
                              </div>
                            );
                          })
                    ...
                    <input
                      type="submit"
                      className="submitBTn48"
                      value="Update"
                    />
                  </form>
                </div>
                <div className="updateDivisionDiv glassTheme addEnNumber">
                  <h4>Add EN Number</h4>
                  <div>
                    <span>
                      <input
