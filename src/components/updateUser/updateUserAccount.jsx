        ...
        <div className="userAcountMainDiv" style={props.main.main}>
          ...
          <div>
            ...
            {loading ? (
              ...
              <div>
                <div className=" " style={props.main.sub_body}>
                  <SearchedClg></SearchedClg>

                  <div className=" ">
                    <form className=" " onSubmit={udateInfo}>
                      ...
                      <label className="custom-field one">
                        ...
                        />
                        <span class="placeholder">College code</span>
                      </label>
                       ...
                       {isValueUdated ? (
                        <div>
                          <h2 id="heading864">College Information</h2>
                          <span>Courses</span>
                          {isAuthenticated
                            ? isValueUdated
                          ...
                          <div className=" ">
                            <input
                              ...
                              required
                              name="email"
                              value={isValueUdated ? user.email : null}
                              placeholder="auto imported from user"
                            />
                          </div>
                          <div className=" ">
                            <input
                              ...
                              name="clgShortName"
                              value={
                                isValueUdated ? clgDetail.clgShortName : null
                              }
                              placeholder="auto imported form college code"
                            />
                          </div>
                              ...
                              <div>
                                ...
                                <div>
                                  ...
                                  <input style={props.main.redioInput}
                                    ...
                                    required
                                    checked={
                                      role === "teacher" ? "Checked" : null
                                    }
                                    value="teacher"
                                    onClick={InformationUpdator}
                                  />
                                  <label htmlFor="role">Techer</label>
                                  <input style={props.main.redioInput}
                                    type="radio"
                                    name="role"
                                    required
                        ...
                        "please Enter the college code to for detail"
                      )}
                    </form>
                  </div>
                 </div>
